...
impl MeApiClient {api_client_link_id!(transitive_member_of_id, TransitiveMemberOfIdApiClient);
api_client_link_id!(owned_device, OwnedDevicesIdApiClient);
api_client_link!(booking_business, BookingBusinessIdApi);
...
api_client_link!(booking_businesses, BookingBusinessApi);
...
api_client_link_id!(chat, ChatsIdApiClient);
	...
	delete!(
		doc: "Delete navigation property employeeExperience for me", 
		name: delete_employee_experience,
		path: "/me/employeeExperience"
	);
	get!(
		doc: "Get employeeExperience from me", 
		name: get_employee_experience,
		path: "/me/employeeExperience"
	);
	patch!(
		doc: "Update the navigation property employeeExperience in me", 
	...
	get!(
		...
		path: "/me/employeeExperience/learningCourseActivities(externalcourseActivityId='{{id}}')",
	...
	get!(
		doc: "Get learningCourseActivity", 
		name: get_learning_course_activities,
		path: "/me/employeeExperience/learningCourseActivities/{{id}}",
	...
	post!(
		doc: "Create new navigation property to permissionGrants for me", 
	...
	delete!(
		doc: "Delete navigation property permissionGrants for me", 
		name: delete_permission_grants,
		path: "/me/permissionGrants/{{id}}",
		params: resource_specific_permission_grant_id
	);
	get!(
		doc: "Get permissionGrants from me", 
		name: get_permission_grants,
		path: "/me/permissionGrants/{{id}}",
		params: resource_specific_permission_grant_id
	);
	patch!(
		doc: "Update the navigation property permissionGrants in me", 
