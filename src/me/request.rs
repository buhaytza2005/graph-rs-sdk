...
impl MeApiClient {api_client_link!(joined_teams, JoinedTeamsApiClient);
...
api_client_link!(booking_business, BookingBusinessIdApiClient);
...
api_client_link!(booking_businesses, BookingBusinessApiClient);
