...
resource_api_client!(SitesListsApiClient, SitesListsIdApiClient, ResourceIdentity::SitesLists);
...
impl SitesListsIdApiClient {api_client_link!(content_types, SitesContentTypesApiClient);
