...
resource_api_client!(TermStoresApiClient, TermStoresIdApiClient, ResourceIdentity::TermStores);
...
impl TermStoresIdApiClient {api_client_link_id!(set, TermStoreSetsIdApiClient);
