...
resource_api_client!(TermStoreSetsParentGroupApiClient, ResourceIdentity::TermStoreSetsParentGroup);

impl TermStoreSetsParentGroupApiClient {api_client_link!(sets, TermStoreSetsApiClient);
