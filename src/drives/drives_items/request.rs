...
resource_api_client!(DrivesItemsApiClient, DrivesItemsIdApiClient, ResourceIdentity::DrivesItems);

impl DrivesItemsApiClient {api_client_link!(last_modified_by_user, LastModifiedByUserApiClient);
