...
resource_api_client!(TodoListsApiClient, TodoListsIdApiClient, ResourceIdentity::TodoLists);
...
impl TodoListsIdApiClient {api_client_link!(tasks, TodoListsTasksApiClient);
api_client_link_id!(task, TodoListsTasksIdApiClient);

	delete!(
		doc: "Delete todoTaskList", 
		name: delete_lists,
		path: "/lists/{{RID}}"
	);
	get!(
		doc: "Get todoTaskList", 
		name: get_lists,
		path: "/lists/{{RID}}"
	);
	patch!(
		doc: "Update todoTaskList", 
		name: update_lists,
		path: "/lists/{{RID}}",
		body: true
	);
