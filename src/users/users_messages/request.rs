...
resource_api_client!(UsersMessagesApiClient, UsersMessagesIdApiClient, ResourceIdentity::UsersMessages);
...
impl UsersMessagesIdApiClient {api_client_link!(attachments, UsersAttachmentsApiClient);
