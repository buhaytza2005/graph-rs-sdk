...
resource_api_client!(OnenoteSectionsApiClient, OnenoteSectionsIdApiClient, ResourceIdentity::OnenoteSections);
...
impl OnenoteSectionsIdApiClient {api_client_link!(sections, OnenoteSectionsApiClient);
