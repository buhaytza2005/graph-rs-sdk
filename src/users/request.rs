...
impl UsersIdApiClient {api_client_link!(calendars, CalendarsApiClient);
...
api_client_link!(booking_business, BookingBusinessApi);
...
api_client_link!(booking_businesses, BookingBusinessIdApi);
