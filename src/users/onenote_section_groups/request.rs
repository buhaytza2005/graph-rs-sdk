...
resource_api_client!(OnenoteSectionGroupsApiClient, OnenoteSectionGroupsIdApiClient, ResourceIdentity::OnenoteSectionGroups);
...
impl OnenoteSectionGroupsIdApiClient {api_client_link_id!(section, OnenoteSectionsIdApiClient);
