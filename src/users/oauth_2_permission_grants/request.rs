...
resource_api_client!(Oauth2PermissionGrantsApiClient, Oauth2PermissionGrantsIdApiClient, ResourceIdentity::Oauth2PermissionGrants);

impl Oauth2PermissionGrantsApiClient {
	get!(
		doc: "List a user's oauth2PermissionGrants", 
		name: users_list_oauth_2_permission_grants,
		path: "/oauth2PermissionGrants"
	);
	get!(
		doc: "Get the number of the resource", 
		name: oauth_2_permission_grants,
