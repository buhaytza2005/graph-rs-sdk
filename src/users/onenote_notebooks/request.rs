...
resource_api_client!(OnenoteNotebooksApiClient, OnenoteNotebooksIdApiClient, ResourceIdentity::OnenoteNotebooks);
...
impl OnenoteNotebooksIdApiClient {api_client_link_id!(section, OnenoteSectionsIdApiClient);
