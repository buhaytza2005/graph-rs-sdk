...
impl TeamworkApiClient {api_client_link_id!(deleted_team, DeletedTeamsIdApiClient);
api_client_link!(deleted_teams, DeletedTeamsApiClient);
	...
	get!(
		doc: "Get team from users", 
		name: get_team,
		path: "/teamwork/associatedTeams/{{id}}/team",
		params: associated_team_info_id
	);
	post!(
	...
	get!(
		...
		name: get_teams_app,
		path: "/teamwork/installedApps/{{id}}/teamsApp",
		params: user_scope_teams_app_installation_id
	);
	get!(
		doc: "Get teamsAppDefinition from users", 
		name: get_teams_app_definition,
		path: "/teamwork/installedApps/{{id}}/teamsAppDefinition",
		params: user_scope_teams_app_installation_id
	);
	post!(
